# Embedding and Chunking Strategy — Source Ledger and Evidence Governance

## Chunking rule

Chunk by claim cluster, not by arbitrary token windows. Preserve source URL/path, evidence grade, date/day, claim type, and derived-card ID in metadata.

## Required metadata fields

- `lane_id`: `RP01`
- `lane_title`: `Source Ledger and Evidence Governance`
- `source_family`
- `source_path`
