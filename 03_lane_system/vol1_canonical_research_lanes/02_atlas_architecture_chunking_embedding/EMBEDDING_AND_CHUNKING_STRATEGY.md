# Embedding and Chunking Strategy — RAG Architecture, Chunking, and Embedding Strategy

## Chunking rule

Create chunks by document role: markdown by heading tree, CSV by row/row-group, JSON by object, code by function/block, manifests as metadata-only unless auditing.

## Required metadata fields

- `lane_id`: `RP02`
- `lane_title`: `RAG Architecture, Chunking, and Embedding Strategy`
- `source_family`
- `source_path`
