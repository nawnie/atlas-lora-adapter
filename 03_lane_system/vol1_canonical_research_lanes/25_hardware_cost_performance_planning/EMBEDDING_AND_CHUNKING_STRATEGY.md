# Embedding and Chunking Strategy — Hardware Cost and Performance Planning
...
## Chunking Rules
- Preserve topic number `25` and slug `25_hardware_cost_performance_planning` in metadata.
