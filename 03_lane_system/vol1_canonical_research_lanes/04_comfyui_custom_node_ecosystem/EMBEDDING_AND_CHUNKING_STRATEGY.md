# Embedding and Chunking Strategy — ComfyUI Custom Node Ecosystem and Nodepack Evaluation

## Chunking rule

Chunk per nodepack and per node family. Preserve class_type, repo, safety policy, dependency notes, and workflow-generation policy together.

## Required metadata fields

- `lane_id`: `RP04`
- `lane_title`: `ComfyUI Custom Node Ecosystem and Nodepack Evaluation`
- `source_family`
- `source_path`
