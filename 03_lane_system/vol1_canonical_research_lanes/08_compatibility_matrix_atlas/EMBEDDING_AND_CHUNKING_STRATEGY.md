# Embedding and Chunking Strategy — Compatibility Matrix RAG

## Chunking rule

Chunk by compatibility relationship: actor A, requirement B, constraint C, failure if missing, test command, remediation.

## Required metadata fields

- `lane_id`: `RP08`
- `lane_title`: `Compatibility Matrix RAG`
- `source_family`
- `source_path`
