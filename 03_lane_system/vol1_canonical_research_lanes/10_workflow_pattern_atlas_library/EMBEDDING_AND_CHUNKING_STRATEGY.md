# Embedding and Chunking Strategy — Workflow Pattern Library RAG

## Chunking rule

Chunk by graph pattern. Preserve inputs, required custom nodes, required model assets, safety level, and failure signatures together.

## Required metadata fields

- `lane_id`: `RP10`
- `lane_title`: `Workflow Pattern Library RAG`
- `source_family`
- `source_path`
